...
No se procesó el registro, vuelva a intentarlo.
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
</button>
</div>
...
<a class="btn btn-primary mb-4" href="conventions-add.php">Agregar Nuevo</a>
            ...
            <table class="table table-bordered" id="myTable" width="100%" cellspacing="10">
                <thead>
                    <tr>
                        ...
                        <th class="col-8">Descripci&oacute;n</th>
