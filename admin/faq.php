<?php include("open.php");?>
    ...
    <a class="btn btn-primary mb-4" href="faq-add.php">Agregar Nuevo</a>
                ...
                <table class="table table-bordered" id="myTable" width="100%" cellspacing="10">
                    ...
                    <tbody>
                        ...
                        <td class="text-center">
                            ...
                            <a href="faq-actions.php?del=true&id=<?php echo $row['id']?>" onclick="return confirm('Do you want to continue? It will be permanently deleted')"><i class="fas fa-trash-alt"></i></a>
                        </td>
